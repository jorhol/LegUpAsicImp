...
static const char qt_meta_stringdata_ChartView[] = {
    "ChartView\0\0value\0setScrollBarValue(int)\0"
};
...
void ChartView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setScrollBarValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ChartView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ChartView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_ChartView,
      qt_meta_data_ChartView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ChartView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChartView))
